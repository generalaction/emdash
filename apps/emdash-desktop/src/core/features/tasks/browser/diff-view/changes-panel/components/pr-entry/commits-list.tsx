...
import { usePrefetchDiffModels } from '@core/features/tasks/browser/diff-view/changes-panel/hooks/use-prefetch-diff-models';
import { activeDiffEntry } from '@core/features/tasks/browser/diff-view/pane-selectors';
import {
  useTaskViewContext,
  useWorkspaceId,
