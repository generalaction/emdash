...
import { ConversationStore } from '@core/features/conversations/browser/conversation-manager';
import { conversationRegistry } from '@core/features/conversations/browser/stores/conversation-registry';
import { releaseConversationSessionManager } from '@core/features/conversations/browser/stores/conversation-session-manager';
import {
  taskChromeMemento,
...
vi.mock('@core/features/conversations/browser/conversation-title-utils', () => ({
