...
} from '@core/features/tasks/browser/stores/lifecycle-scripts';
import { type TerminalTabViewStore } from '@core/features/tasks/browser/terminals/terminal-tab-view-store';
