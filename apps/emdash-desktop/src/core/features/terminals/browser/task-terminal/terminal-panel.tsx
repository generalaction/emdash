...
import { lifecycleScriptsStoreToken } from '@core/features/workspaces/browser/contributions/workspace-stores';
...
import { TerminalDrawerTabBar, type TerminalDrawerMode } from './terminal-drawer-tab-bar';
