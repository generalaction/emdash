...
function handleAnchorClick(
  ...
  openExternalLink: OpenExternalLink | undefined,
  e: React.MouseEvent
) {
  if (!href) return;
  if (onOpenLink?.(href)) {
...
function useFullComponents(
  ...
  return useMemo(
    () => ({
      ...
      a: ({ href, children }: AnchorProps) => {
        const handleClick = (e: React.MouseEvent) => {
          handleAnchorClick(href, onOpenLink, openExternalLink, e);
        };
        return (
          <a
            href={href}
    ...
    [isDark, resolveImage, onOpenLink, openExternalLink]
  );
}
...
function useCompactComponents(
  ...
  return useMemo(
    ...
    [isDark, onOpenLink, openExternalLink]
  );
}
...
export const MarkdownRenderer: React.FC<MarkdownRendererProps> = ({
  ...
  const fullComponents = useFullComponents(isDark, resolveImage, onOpenLink, openExternalLink);
  const compactComponents = useCompactComponents(isDark, onOpenLink, openExternalLink);
