...
import { isAbortError, isNetworkError, type PullRequestOperationErrorType } from '../../errors';

export function mapGitHubAuthError(error: GitHubAuthError): PullRequestError {
  switch (error.type) {
    case 'auth_required':
