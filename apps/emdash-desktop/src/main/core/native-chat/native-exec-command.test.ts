...
import {
  ...
  isCodexThreadId,
  isPiThinkingLevel,
  type NativeExecProviderConfig,
} from './native-exec-command';

const CODEX_CONFIG: NativeExecProviderConfig = {
  cli: 'codex',
  autoApproveFlag:
...
const CLAUDE_CONFIG: NativeExecProviderConfig = {
  cli: 'claude',
  autoApproveFlag: '--dangerously-skip-permissions',
};

const PI_CONFIG: NativeExecProviderConfig = {
  cli: 'pi',
