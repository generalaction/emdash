...
import type { TabProvider, TabViewContext } from '@renderer/features/tabs/core/tab-provider';
import {
  createTabRegistry,
  type KindOf,
  type OpenArgsOf,
...
type ProviderEntry<P> =
  P extends TabProvider<infer _K, infer E, infer _RD, infer _D, infer _A> ? E : never;
type ProviderResolved<P> =
  P extends TabProvider<infer _K, infer _E, infer RD, infer _D, infer _A> ? RD : never;
type ProviderData<P> =
  P extends TabProvider<infer _K, infer _E, infer _RD, infer D, infer _A> ? D : never;
