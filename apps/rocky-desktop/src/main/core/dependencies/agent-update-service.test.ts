import type { DependencyStatusUpdatedEvent, DependencyId } from '@rocky/core/deps/runtime';
import type { HostDependencyManager } from '@rocky/core/deps/runtime';
import { Emitter } from '@rocky/shared';
