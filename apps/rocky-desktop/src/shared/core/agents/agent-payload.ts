...
// ---------------------------------------------------------------------------
// Install methods — mirrors INSTALL_METHODS in @rocky/core/deps/capability.ts
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Installation state — mirrors @rocky/core/deps/runtime types.ts
// ---------------------------------------------------------------------------

export type DependencyStatus = 'available' | 'missing' | 'error';

/**
 * Installation provenance — mirrors Provenance in @rocky/core/deps/runtime types.ts.
 */
 ...
 * Mirrors resolveActiveInstallation from @rocky/core/deps/runtime.
 */
...
// ---------------------------------------------------------------------------
// Error DTOs — mirrors Dependency*Error types in @rocky/core/deps/runtime
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Icon asset DTO — mirrors AgentIconAsset from @rocky/core/agents/plugins
// ---------------------------------------------------------------------------
