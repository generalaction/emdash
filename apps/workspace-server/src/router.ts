...
export const router = i.router({
  ...
  git: {
    ...
    cloneRepository: {
      start: i.git.cloneRepository.start.handler(notImplemented),
      cancel: i.git.cloneRepository.cancel.handler(notImplemented),
      snapshot: i.git.cloneRepository.snapshot.handler(notImplemented),
      subscribe: i.git.cloneRepository.subscribe.handler(notImplemented),
      unsubscribe: i.git.cloneRepository.unsubscribe.handler(notImplemented),
    },
    repository: {
      refs: {
      ...
      fetch: {
        start: i.git.repository.fetch.start.handler(notImplemented),
        cancel: i.git.repository.fetch.cancel.handler(notImplemented),
        snapshot: i.git.repository.fetch.snapshot.handler(notImplemented),
        subscribe: i.git.repository.fetch.subscribe.handler(notImplemented),
        unsubscribe: i.git.repository.fetch.unsubscribe.handler(notImplemented),
      },
      publishBranch: {
        start: i.git.repository.publishBranch.start.handler(notImplemented),
        cancel: i.git.repository.publishBranch.cancel.handler(notImplemented),
        snapshot: i.git.repository.publishBranch.snapshot.handler(notImplemented),
        subscribe: i.git.repository.publishBranch.subscribe.handler(notImplemented),
        unsubscribe: i.git.repository.publishBranch.unsubscribe.handler(notImplemented),
      },
      getDefaultBranch: i.git.repository.getDefaultBranch.handler(notImplemented),
      fetchPrForReview: {
        start: i.git.repository.fetchPrForReview.start.handler(notImplemented),
        cancel: i.git.repository.fetchPrForReview.cancel.handler(notImplemented),
        snapshot: i.git.repository.fetchPrForReview.snapshot.handler(notImplemented),
        subscribe: i.git.repository.fetchPrForReview.subscribe.handler(notImplemented),
        unsubscribe: i.git.repository.fetchPrForReview.unsubscribe.handler(notImplemented),
      },
    ...
    checkout: {
      ...
      push: {
        start: i.git.checkout.push.start.handler(notImplemented),
        cancel: i.git.checkout.push.cancel.handler(notImplemented),
        snapshot: i.git.checkout.push.snapshot.handler(notImplemented),
        subscribe: i.git.checkout.push.subscribe.handler(notImplemented),
        unsubscribe: i.git.checkout.push.unsubscribe.handler(notImplemented),
      },
      pull: {
        start: i.git.checkout.pull.start.handler(notImplemented),
        cancel: i.git.checkout.pull.cancel.handler(notImplemented),
        snapshot: i.git.checkout.pull.snapshot.handler(notImplemented),
        subscribe: i.git.checkout.pull.subscribe.handler(notImplemented),
        unsubscribe: i.git.checkout.pull.unsubscribe.handler(notImplemented),
      },
      sync: {
        start: i.git.checkout.sync.start.handler(notImplemented),
        cancel: i.git.checkout.sync.cancel.handler(notImplemented),
        snapshot: i.git.checkout.sync.snapshot.handler(notImplemented),
        subscribe: i.git.checkout.sync.subscribe.handler(notImplemented),
        unsubscribe: i.git.checkout.sync.unsubscribe.handler(notImplemented),
      },
