...
Skills are reusable capability modules that extend your agents with specialized functionality. They follow the open [Agent Skills](https://agentskills.io) standard and work across all supported agents—Claude Code, Codex, OpenCode, Cursor, Gemini, Roo Code, and Mistral Vibe.
...
This means skills you install through Scrawl also work when you run these agents outside of Scrawl.
