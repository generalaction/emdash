...
If tasks start local servers, use `EMDASH_PORT` in your `.emdash.json` scripts to avoid port collisions between parallel tasks. See [Project Configuration](/project-config).
