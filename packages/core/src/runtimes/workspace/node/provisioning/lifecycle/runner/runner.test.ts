...
import type { BootstrapStepRegistry } from '@runtimes/workspace/node/provisioning/lifecycle/steps/registry';
import { bootstrapStepRegistry } from '@runtimes/workspace/node/provisioning/lifecycle/steps/registry';
