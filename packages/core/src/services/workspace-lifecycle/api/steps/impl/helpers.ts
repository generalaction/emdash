import type { BootstrapError } from '@services/workspace-lifecycle/api/api/schemas';
import { gitErrorMessage, type GitRunError } from '@services/workspace-lifecycle/api/steps/run-git';
