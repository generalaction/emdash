import { SURFACE_LEVELS, SURFACE_ROLES } from '@emdash/theme';
...
import { chatHostAdapterClassName } from '@emdash/ui/react/chat-ui/host-adapter';
...
const withTheme: Decorator = (Story, context) => {
  ...
  const frameClassName = [chatHostAdapterClassName, surfaceClass].filter(Boolean).join(' ');
