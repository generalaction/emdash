...
/**
 * The Model Context Protocol logo as a scalable React icon.
 *
 * Renders three connected rounded strokes using the official MCP mark so it
 * stays crisp at any size and inherits the surrounding text color.
 */
export const McpIcon = React.forwardRef<SVGSVGElement, McpIconProps>(function McpIcon(
