...
const fontWeightVar = (value: string) => value as never;
  ...
  variants: {
    variant: {
      body: {
        ...
        fontWeight: fontWeightVar('var(--type-body-font-weight)'),
        lineHeight: 'var(--type-body-line-height)',
      },
      bodyBold: {
        fontFamily: 'var(--type-body-bold-font-family)',
        fontSize: 'var(--type-body-bold-font-size)',
        fontWeight: fontWeightVar('var(--type-body-bold-font-weight)'),
      ...
      bodyItalic: {
        ...
        fontWeight: fontWeightVar('var(--type-body-italic-font-weight)'),
        fontStyle: 'italic',
