...
These eval cases check the behavior of the `emdash-agent-operator` agent plugin, not Emdash itself. They are meant to verify that the plugin produces useful plans, safe boundaries, and concrete acceptance checks for common Emdash workflows.
