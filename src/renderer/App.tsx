      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            className="absolute left-2 top-2 z-50 h-8 w-8 rounded-md bg-background/80 backdrop-blur-sm border border-border/50 shadow-sm text-muted-foreground hover:bg-accent hover:text-foreground transition-all"
          ...
          if (isAuthenticated && isGithubRemote) {
            ...
            if (githubInfo.success) {
              ...
              if (saveResult.success) {
                setProjects((prev) => {
                  const newList = [projectWithGithub, ...prev];
            ...
            if (saveResult.success) {
              setProjects((prev) => {
                const newList = [projectWithoutGithub, ...prev];
                saveProjectOrder(newList);
                return newList;
              });
